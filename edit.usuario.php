...
$resultUsuario = "SELECT * FROM `usuario` WHERE idusuario = $idusuario";
$resultadoUsuario = mysqli_query($conexao, $resultUsuario);
$rowUsuario= mysqli_fetch_assoc($resultadoUsuario);

$idempresa = $_GET['idusuario'];
$resultEmpresa = "SELECT * FROM `usuario` WHERE idusuario = $idusuario";
$resultadoEmpresa = mysqli_query($conexao, $resultEmpresa);
$rowEmpresa= mysqli_fetch_assoc($resultadoEmpresa);
        ...
        <div id="main_container" class="span10">
            ...
            <div class="row-fluid">
	            <div class="span12 shortcut">
                	<a href="#" class="btn btn-shortcut"><img src="images/icons/grey/Home.png" alt="Dashboard" />Edita Usuário<span class="label label-success">9</span></a>
            ...
            <div class="row-fluid">
            	<div class="span12">
                    ...
                    <div class="box grad_colour_dark_blue" id="box_4">
                        <h2 class="box_head round_top">Editar Usuarios</h2>
                        ...
                        <div class="toggle_container">					
                            ...
                            <div class="block box_content round_bottom padding_20">
                                ...
                                <form name="edituser" method="POST" class="form-horizontal" action="componentes/edit.usuario.php">
                                  ...
                                  <div class="control-group" >
                                      <label class="control-label" for="idusuario"></label>
                                      <div class="controls">
                                        <input type="hidden" class="input-xlarge" name="idusuario" value="<?php echo $rowUsuario['idusuario'];?>"required>
                                      </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                      ...
                                      <div class="controls">
                                        <input type="text" class="input-xlarge" name="nome" value="<?php echo $rowUsuario['nome'];?>"required>
                                    ...
                                    <div class="control-group">
                                      ...
                                      <div class="controls">
                                        <input type="text" class="input-xlarge" name="login" value="<?php echo $rowUsuario['login']; ?>"required>
                                        <p class="help-block">Here you can add help text.</p>
                                      </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                      ...
                                      <div class="controls">
                                        <input type="password" class="input-xlarge" name="senha" value="<?php echo $rowUsuario['senha'];?>"required>
                                        <p class="help-block">Here you can add help text.</p>
                                      </div>
                                    </div>  
                                    <div class="control-group">
                                    ...
                                    <div class="controls docs-input-sizes">
                                      ...
                                      ?>
                                        <option value="<?php echo $row_empresas['idempresa']; ?>" <?=$rowUsuario["idempresa"] == $row_empresas['idempresa'] ? "selected" : "";?>><?php echo $row_empresas['empresa'];?>
