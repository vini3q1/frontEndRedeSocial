      ...
      <div class="row-fluid">
          <div id="side_nav" class="span2 sidebar-nav side_nav">
              <span id="logo" class="logo">&nbsp;</span>
                  <ul class="clearfix">
                      <li><a class="round_top" href="dashboard.php">
                      ...
                      <a href="layout.html">
                          ...
                          <div class="accordion">
                              <a href="contasPagarList.php">Contas a Pagar</a>
                              <a href="contasReceberList.php">Contas a Receber</a>
                          </div>	
                      </li>	
                      <li>
                      <a href="layout.html">
                          <img src="images/icons/grey/create_write.png">
                          <span>Cadastro</span>
                          <span class="icon">&nbsp;</span></a>
                          <div class="accordion">
                              <a href="usuarios.list.php">Usuários</a>
                              <a href="alunos.list.php">Alunos</a>
                              <a href="fornecedorList.php">Fornecedor</a>
                          </div>	
                      </li>	   
