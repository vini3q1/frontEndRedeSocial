<?php
    ...
    include('componentes/fornecedor.php');
    
    
    $fornecedorcomp = new Fornecedor();
    $fornecedorcomp->conexao = $conexao;
    $fornecedorlistar = $fornecedorcomp->GetAll();
            ...
            <div class="row-fluid">      
              <div class="span12">      
                <div class="box grad_colour_dark_blue">
                    <h2 class="box_head round_top">Lista de fornecedores</h2>
                    ...
                    <td align="left">																			
										  <a class="btn btn-info" href="fornecedor.php">
                        ...
                        <table cellpadding="" cellspacing="0" border="0" class="display datatable" id="datatable">
                                  ...
                                  <tbody>
                                    <?php
                                      ...
                                      while($atp = mysqli_fetch_array($fornecedorlistar,MYSQLI_ASSOC))
                                              {	   
                                    ?>
                                              <tr>
                                                <td class="center"><?=$atp["idfornecedor"];?></td>
                                                <td class="center"><?=$atp["fornecedor"];?></td>				
                                                <td class="center">												
