...
<html lang="en">
  ...
  <body id="forms"><!-- This id is used for the cookies -->
            ...
            <div class="row-fluid">
            	<div class="span12">
                    ...
                    <div class="box grad_colour_dark_blue" id="box_4">
                        <h2 class="box_head round_top">Upgrow - Fornecedores</h2>
                        ...
                        <div class="toggle_container">					
                            ...
                            <div class="block box_content round_bottom padding_20">
                                ...
                                <form name="insereFornecedor" class="form-horizontal" action="componentes/recebeFornecedor.php" method="POST">
                                  ...
                                  <legend>Novo Fornecedor</legend>
                                    ...
                                    <div class="control-group">
                                      ...
                                      <div class="controls">
                                        <input type="text" class="input-xlarge" name="fornecedor">
                                        <p class="help-block">Insira nome do prestador</p>
                                      </div>
                                     </div>
    ...
    <script>
      ...
      function validar(){
          ...
          var nome = insereFornecedor.nome.value

          if(nome == ""){
            alert("Preencha o Fornecedor");
            document.insereFornecedor.nome.focus();
             return false 
          }          
  ...
  <script>
    function cancelar(){
      location.href="fornecedorList.php"
    }
  </script>
  </body>
</html>                        